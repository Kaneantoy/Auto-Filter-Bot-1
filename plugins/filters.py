    ...
    if query.message.reply_to_message.from_user.id == query.from_user.id:
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/joinchat/6BVobfZLOFxlNmFl")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("Creator😎", url="https://t.me/Blur_Glass")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("SOURCE CODE", url="https://github.com/Kaneantoy/Auto-Filter-Bot-1")]
            ])
